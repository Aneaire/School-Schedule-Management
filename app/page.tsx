...
import { Award, Book, Bookmark, Mail, Search, Sparkles } from "lucide-react";
...
const TeacherDashboard = () => {
  ...
  const allSubjects = [
    ...new Set(teachers.map((teacher) => teacher.majorSubject)),
  ].sort();
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-950 text-gray-100">
      ...
      <main className="flex-1 container mx-auto px-6 py-7">
                ...
                <CardFooter className="pt-1 border-t border-gray-700">
                  <div className="flex items-center justify-between w-full text-sm">
                    <span className="flex items-center text-gray-400">
                      ...
                      Specialization :
                      <Badge className="bg-gray-700 ml-1.5 hover:bg-gray-600 text-gray-300">
